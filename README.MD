# ![VASCilia Logo](Napari_VASCilia_v1_0_0/src/assets/VASCilia_logo1.png) VASCilia (Vision Analysis StereoCilia): A Napari Plugin for Deep Learning-Based 3D Analysis of Cochlear Hair Cell Stereocilia Bundles  
