...
<p>
  <img src="src/assets/VASCilia_logo1.png" alt="VASCilia Logo" width="100" style="float:left; margin-right:10px;">
  <strong>VASCilia</strong> Explore the complexities of the cochlea with VASCilia, a Napari plugin created to aid in the 3D segmentation and quantification of stereocilia bundles. Equipped with a range of thoughtful features, VASCilia stands for (Vision Analysis StereoCilia) and it provides a supportive tool for auditory research, including:  
</p>
