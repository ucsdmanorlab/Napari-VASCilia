...
class NapariPlugin:
    ...
    def create_default_config(self, config_path):
        ...
        default_config = {
            ...
            "ZFT_trim_model": str('C:/Users/..../models/ZFT_trim_model/'),
            "rotation_correction_model": str('C:/Users/..../models/rotation_correction_model/'),
            "green_channel": 0,
            "red_channel": 1,
            "blue_channel": -1,
    ...
    def setup_variables(self):
        ...
        self.subtract_background = self.config.get('subtract_background', False)
        self.dilate_labels = self.config.get('dilate_labels', False)
        self.BUTTON_WIDTH = self.config.get('button_width', 60)
        self.BUTTON_HEIGHT = self.config.get('button_height', 18)
        self.force_manual_resolution = int(self.config.get('force_manual_resolution', 0))
